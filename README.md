...
퇴근 후 자기 계발로 Kotlin을 공부 했었고, 이 경험을 실무에 제안해 안드로이드 웹 뷰 프로젝트를 완수했습니다. 
개인 토이 프로젝트에서는 이전에 사용해 보지 않았던 Spring boot, REST API, JPA 등을 사용해 AWS의 EC2 환경에서 Docker로 배포했습니다. 
...
+ 제조사가 받은 견적 의뢰에 대한 견적서 제공 시스템 개발
  + Spring과 JSP를 사용한 CRUD 견적 시스템 API 개발
