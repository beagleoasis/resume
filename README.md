...
안녕하세요. 2년 차 웹 백엔드 개발자 김정민입니다.

'사람과 사람을 연결하는 일'에 관심이 많아 여행사에서 근무했고, 
현재는 Java & Spring 기반의 백엔드 개발자로서 '소통의 창을 구현하는 즐거움'을 느끼고 있습니다.

'꾸준한 자기 계발'의 중요성을 느끼고, 성장을 위해 끊임없이 노력하고 있습니다. 
개인 토이 프로젝트에서 Spring boot, REST API, JPA 등을 사용해 AWS의 EC2 환경에서 Docker로 배포했습니다.
퇴근 후 취미로 Kotlin을 공부했고, 실무에서 하이브리드 앱 Web View 프로젝트를 단독으로 완수한 경험이 있습니다. 
