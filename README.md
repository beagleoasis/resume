...
개발자는 시대의 흐름에 맞춰, 평생 새로운 것을 배워야 하는 직업이라고 생각합니다. 그래서 항상 경험해보지 못한 기술에 호기심을 갖고 배우려고 노력하고 있습니다. 

취미로 공부한 코틀린으로 실무에서 웹 뷰 안드로이드 앱을 구현했고, 실무에서 사용하지 않았던 Spring boot, JPA, REST API 등을 활용해 토이 프로젝트를 만든 경험이 있습니다.
...
1. 국내 제조사 소싱 플랫폼 [메이커빌](https://www.makervil.com) 백엔드 개발
(2022.05 ~ 2023.02)
+ 제조기업 견적 의뢰 게시판 구현
