...
'사람과 사람을 연결하는 일'에 관심이 많아 여행사에서 근무했고, 현재는 웹 개발자로서 '사람 간 소통을 구현하는 즐거움'을 느끼고 있습니다.

'꾸준함'의 중요성을 느끼고 저의 부족한 부분을 채워나가려고 노력하고 있습니다. 자기 계발로 공부했던 Kotlin을 활용해 실무에서 안드로이드 웹 뷰 프로젝트를 진행했고, 개인 토이 프로젝트에서 실무에서 사용하지 않았던 Spring boot, REST API, JPA 등을 사용해 AWS로 배포한 경험이 있습니다. 또한 학습한 내용을 정리하는 기술 블로그를 운영하고 있습니다.
...
### 메이커빌(2021.06 ~ 2023.02, 개발팀 백엔드 개발자)

1. 국내 제조사 소싱 플랫폼 메이커빌 백엔드 개발
(2022.05 ~ 2023.02)
+ 제조기업 견적 의뢰 게시판 구현
  + 게시판 기본 CRUD, 검색어 필터/정렬, 페이징, 대댓글, 추천 기능 구현
+ Linux 기반 AWS 운영 서버 관리
+ 제조사 검색 페이지, 마이페이지 리뉴얼
  + 제조사 검색 페이지 필터/정렬 구현
  + 마이페이지-제품 견적문의 페이지-검색/정렬/작성 상태 반영 구현 

2. 국내 제조 상품 쇼핑몰 [메이커갤러리](https://makergallery.co.kr/mw/main/index.do) 안드로이드 앱 개발
(2022.02 ~ 2022.04)
+ 안드로이드 코틀린을 활용한 웹 뷰 개발
+ 이니시스 결제 모듈 모바일 연동 작업
  + 이니시스 PC페이지 리턴값의 모바일 연동 구현
