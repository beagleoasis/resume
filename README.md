# 호기심, 친화력, 그리고 성장 욕구
<img src="https://user-images.githubusercontent.com/73637960/224198390-8e55b5de-3924-4754-9f38-392f9b578ac5.jpeg" width="250" height="300"/>

안녕하세요. 

'배움에 대한 호기심'과 '꾸준한 자기 계발'로 살아온 2년 차 자바 백엔드 개발자 김정민입니다.

저는 새로운 기술에 호기심을 갖습니다. 퇴근 후 자기 계발로 안드로이드 코틀린을 공부했고,
이 경험을 실무에 제안해 단독으로 웹 뷰 하이브리드 앱 프로젝트를 완수한 경험이 있습니다.

또한 꾸준히 성장을 위해 노력합니다. 실무 역량을 강화하고자, 개인 토이 프로젝트에서 Spring Boot, REST API, JPA 등을 사용해 AWS의 EC2 환경에서 Docker로 배포했습니다. 그리고 이 경험을 실무에 적용해 REST API를 도입했습니다. 학습한 내용을 정리하는 기술 블로그도 꾸준히 운영해 오고 있습니다. 

저의 '호기심'과 '성장 욕구'를 바탕으로 매일 성장할 수 있는 개발자가 되려고 노력하고 있습니다.
...
+ 제조사가 받은 견적 의뢰에 대한 견적서 제공 시스템 개발
  + Spring과 JSP를 사용한 CRUD 견적 시스템 개발
+ 제조사 및 제품 정보 검색 서비스 개발
  + SQL문 리팩토링을 통한 검색 효율 개선
...
+ Spring scheduler를 이용한 백오피스 유저 자동 관리 시스템(적립 포인트, 쿠폰, 휴면 계정 관리) 개발
  + 만료 예정 포인트/쿠폰의 자동 소멸 안내 이메일 발송 처리 및 만료된 포인트/쿠폰의 삭제
  + 장기 미접속 유저의 휴면 계정 처리 안내 메일 발송 및 휴면 처리
+ Ajax Paging을 사용한 제조기업 브랜드 목록/상품 조회 서비스 개발
+ 마이페이지-포인트/쿠폰/리뷰 페이지 개발
...
+ Medicine Hat College(Canada, 2016.01 ~ 2016.06, 교환학생)
...
+ 국비 지원 Java Web 개발 교육과정 수료(2020.10 ~ 2021.05)
