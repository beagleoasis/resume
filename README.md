...
개발자는 시대의 흐름에 맞춰, 평생 새로운 것을 배워야하는 직업이라고 생각합니다. 그래서 항상 경험해보지 못한 기술에 호기심을 갖고 배우려고 노력하고 있습니다. 

취미로 공부했던 코틀린으로 실무에서 웹뷰 안드로이드앱을 구현했고, 실무에서 사용하지 않았던 Spring boot, JPA, REST API 등을 활용해 토이 프로젝트를 만든 경험이 있습니다.
...
+ 스프링 스케줄러를 이용한 휴면 계정/포인트/쿠폰 관리 구현
+ 브랜드 갤러리 게시판 구현
+ 마이페이지 구현
