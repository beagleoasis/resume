...
'꾸준한 자기 계발'의 중요성을 느끼고, 저의 부족한 부분을 채워나가려고 노력하고 있습니다. 
개인 토이 프로젝트에서 Spring boot, REST API, JPA 등을 사용해 AWS의 EC2 환경에서 Docker로 배포한 경험이 있습니다. 
퇴근 후 취미로 Kotlin을 공부했던 경험을 살려, 실무에서 하이브리드 앱 Web View 프로젝트를 단독으로 완수했습니다. 
